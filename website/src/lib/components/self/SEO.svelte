...
<svelte:head>
	...
	<meta property="og:site_name" content="Dingoplay" />
	...
	<meta name="application-name" content="Dingoplay" />
	<meta name="apple-mobile-web-app-title" content="Dingoplay" />
