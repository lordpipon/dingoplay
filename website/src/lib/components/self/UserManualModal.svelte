<script lang="ts">
	...
	const tips: Tip[] = [
		{
			id: 1,
			title: 'Welcome to Dingoplay!',
			description:
				'Dingoplay is a cryptocurrency trading simulator where you can practice trading without real financial risk. Start with virtual money, create coins, make predictions on markets, and most importantly, rugpull!',
			icon: BookOpen01Icon,
		...
		},
		{
			...
			description:
				'Dingoplay uses an AMM system where prices are calculated automatically based on supply and demand. The more you buy, the higher the price goes. The more you sell, the lower it drops. Large trades create "slippage" - the price change during your trade.',
			icon: BarChartIcon,
			image: '/tips/amm.avif'
		},
		{
