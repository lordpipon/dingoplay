...
<Sidebar.Root collapsible="offcanvas">
	<Sidebar.Header>
		<div class="flex items-center gap-2 px-2 py-2">
			<img src="/dingoplay.svg" class="h-5 w-5" alt="Dingoplay" />
			<div class="flex items-center gap-2">
				<span class="text-base font-semibold">Dingoplay</span>
								...
								{#snippet child({ props }: { props: MenuButtonProps })}
									...
									>
										...
										{#if item.title === 'VIP' && $USER_DATA && hasFlag($USER_DATA?.flags, 'IS_VIP')}
											<Sidebar.MenuBadge class="bg-yellow-500 text-black">👑</Sidebar.MenuBadge>
										{/if}
									</a>
								{/snippet}
							</Sidebar.MenuButton>
