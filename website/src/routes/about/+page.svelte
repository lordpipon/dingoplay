...
<svelte:head>
	<title>About - Dingoplay</title>
	<meta
		name="description"
		content="Learn about Dingoplay - a realistic cryptocurrency trading simulation focusing on DeFi risks and mechanics."
	/>
</svelte:head>
...
<div class="container mx-auto space-y-8 px-4 py-8">
	<div class="space-y-4 text-center">
		<div class="mb-4 flex items-center justify-center gap-2">
			<img src="/Dingoplay.svg" class="h-12 w-12" alt="Dingoplay" />
			<h1 class="text-4xl font-bold">Dingoplay</h1>
		</div>
	...
	<div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
			...
			<CardContent>
				<div class="space-y-3">
					<p class="text-muted-foreground text-sm">
						Dingoplay is a realistic cryptocurrency trading simulation that focuses on DeFi
		...
		<Card>
			...
			<CardContent>
				<div class="space-y-4">
					<p class="text-muted-foreground text-sm">Created by <strong>Dingodev</strong></p>
					<div class="flex flex-wrap gap-2">
						...
						<Button
							variant="outline"
							size="sm"
							href="https://discord.gg/CcEYybRUz2"
							target="_blank"
							rel="noopener"
						>
