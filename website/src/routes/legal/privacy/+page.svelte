...
<SEO
	title="Privacy Policy - Dingoplay"
	description="Privacy Policy for Dingoplay cryptocurrency simulation game. Learn about data collection, account deletion process, virtual currency privacy, and your rights."
	...
	<Card.Root class="p-6">
		...
		<div class="space-y-2">
			<Card.Content>
				...
				<p>
					<strong>Platform Note:</strong> Dingoplay is a simulated trading environment using virtual currency
			...
			<div class="rounded-lg p-4 text-sm" style="background-color: oklch(var(--primary) / 0.1);">
				...
				<p><strong>Platform:</strong> Dingoplay - virtual cryptocurrency trading simulation</p>
			</div>
		</div>
